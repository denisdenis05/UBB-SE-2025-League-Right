...
namespace Duo.Services
{
    public class ExerciseService : IExerciseService
    {
        ...
        public ExerciseService(ExerciseRepository fieldExerciseRepository)
        {
            exerciseRepository = fieldExerciseRepository ?? throw new ArgumentNullException(nameof(fieldExerciseRepository));
        }
